...
function RefreshBussHUD()
	...
	if ESX.PlayerData.job.grade_name == 'coboss' or ESX.PlayerData.job.grade_name == 'boss' then
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'coboss' or ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
