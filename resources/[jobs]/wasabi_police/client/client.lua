...
RegisterNetEvent('wasabi_police:clToggleDuty')
AddEventHandler('wasabi_police:clToggleDuty', function(jobName)
    -- print('jobName: ' .. jobName)
    if jobName == 'police' then
        TriggerServerEvent('player:serviceOff', 'police')
    elseif jobName == 'offpolice' then
        TriggerServerEvent('player:serviceOn', 'police')
    end
end)
...
AddEventHandler('wasabi_police:openMdt', function()
    if not HasGroup(Config.policeJobs) then return end
    ExecuteCommand('mdt')
end)
