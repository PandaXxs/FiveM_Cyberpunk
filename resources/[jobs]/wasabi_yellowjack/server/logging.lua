...
-- 		print('[wasabi_yellowpunk] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_yellowpunk:log')
-- AddEventHandler('wasabi_yellowpunk:log', function(cause, killer)
