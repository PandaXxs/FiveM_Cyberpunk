...
Config.Locations = {
    yellowpunk = {
        Blip = {
            Enabled = true,
            Coords = vec3(1990.84, 3054.09, 47.21),
            Sprite = 93,
            Color = 5,
            Scale = 0.6,
            String = 'yellowpunk'
        ...
        BossMenu = {
            ...
            Coords = vec3(1996.45, 3044.91, 50.55), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vec3(1996.45, 3044.91, 50.55),
                heading = 14.8,
                width = 2.0,
                length = 1.0,
                minZ = 43.21-0.9,
        ...
        Coffre = {
            Enabled = true,
            Coords = vec3(1997.95, 3047.24, 47.31), -- Location of boss menu (If not using target)
        ...
        Cloakroom = {
            ...
            Uniforms = { -- Uniform choices
                [1] = { -- Order it will display
                    label = 'yellowpunk', -- Name of outfit that will display in menu
                    male = { -- Male variation
        ...
        yellowpunkSupplies = { -- yellowpunk Shop for supplies
            Enabled = true, -- If set to false, rest of this table do not matter
            Ped = 'g_m_y_lost_03', -- Ped to target
            Coords = vec3(1989.76, 3045.12, 46.21), -- Coords of ped/target
            Heading = 326.39, -- Heading of ped
            Supplies = { -- Supplies
