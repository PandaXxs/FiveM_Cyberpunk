...
Config.SellItems = {
    { item = 'menuBurgerSandy', label = 'Menu Whiteburger', price = {20, 30}},
    { item = 'menuBurgerSandyluxe', label = 'Menu prestige', price = {30, 50}},
}
...
Config.Locations = {
    Bennys = {
        ...
        Blip = {
            Enabled = true,
            Coords = vec3(1430.48, 3723.74, 33.78),
            Sprite = 106,
            Color = 52,
            Scale = 0.6,
            String = '[ENTREPRISE] BurgerSandy'
        },
        ...
        Coffre = {
            Enabled = true,
            Coords = vec3(1416.78, 3728.84, 33.9), -- Location of boss menu (If not using target)
        ...
        BossMenu = {
            ...
            Coords = vec3(1414.37, 3728.53, 33.9), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vec3(1414.37, 3728.53, 33.9),
                heading = 47.4,
                width = 1.0,
                length = 0.5,
                minZ = 43.21,
        ...
        Cloakroom = {
            ...
            Uniforms = { -- Uniform choices
                [1] = { -- Order it will display
                    label = 'burgersandy', -- Name of outfit that will display in menu
                    male = { 
        ...
        BurgerSandySupplies = { -- BurgerSandy Shop for supplies
            Enabled = true, -- If set to false, rest of this table do not matter
            Ped = 's_m_y_chef_01', -- Ped to target
            Coords = vec3(1421.38, 3734.22, 32.9), -- Coords of ped/target
            Heading = 152.06, -- Heading of ped
            Supplies = { -- Supplies
