...
-- 		print('[wasabi_burgersandy] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_burgersandy:log')
-- AddEventHandler('wasabi_burgersandy:log', function(cause, killer)
