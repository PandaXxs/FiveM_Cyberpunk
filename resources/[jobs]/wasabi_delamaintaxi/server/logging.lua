...
-- 		print('[wasabi_delamaintaxi] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_delamaintaxi:log')
-- AddEventHandler('wasabi_delamaintaxi:log', function(cause, killer)
