...
-- 		print('[wasabi_mechanic] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_mechanic:log')
-- AddEventHandler('wasabi_mechanic:log', function(cause, killer)
