...
Config.rocks = { -- Items obtained from mining
    { item = 'emerald', label = 'Emerald', price = {80, 90}, difficulty = {'medium', 'medium', 'easy'} },
    { item = 'diamond', label = 'Diamond', price = {65, 75}, difficulty = {'medium', 'easy', 'easy'} },
    { item = 'copper', label = 'Copper', price = {50, 60}, difficulty = {'medium', 'easy'} },
    { item = 'iron', label = 'Iron', price = {40, 45}, difficulty = {'easy', 'easy'} },
    { item = 'steel', label = 'Steel', price = {25, 35}, difficulty = {'easy', 'easy'} },
}
