...
-- 		print('[wasabi_burgershot] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_burgershot:log')
-- AddEventHandler('wasabi_burgershot:log', function(cause, killer)
