...
Config.Locations = {
    circlebar = {
        Blip = {
            Enabled = true,
            Coords = vec3(344.71, -981.29, 29.39),
            Sprite = 93,
            Color = 48,
            Scale = 0.6,
            String = 'Circlebar'
        ...
        BossMenu = {
            ...
            Coords = vec3(328.29, -984.97, 30.07), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vec3(328.29, -984.97, 30.07),
                heading = 14.8,
                width = 2.0,
                length = 1.0,
                minZ = 43.21-0.9,
        ...
        Coffre = {
            Enabled = true,
            Coords = vec3(342.03, -992.52, 29.37), -- Location of boss menu (If not using target)
        ...
        Cloakroom = {
            ...
            Uniforms = { -- Uniform choices
                [1] = { -- Order it will display
                    label = 'Circlebar', -- Name of outfit that will display in menu
                    male = { -- Male variation
        ...
        circlebarSupplies = { -- circlebar Shop for supplies
            Enabled = true, -- If set to false, rest of this table do not matter
            Ped = 's_m_y_barman_01', -- Ped to target
            Coords = vec3(320.7, -966.3, 28.4), -- Coords of ped/target
            Heading = 182.52, -- Heading of ped
            Supplies = { -- Supplies
