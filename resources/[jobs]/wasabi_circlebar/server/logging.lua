...
-- 		print('[wasabi_circlebar] - Death logs enabled but webhook link is not set in config!')
--         return
--     end
--     if cause then
...
-- RegisterServerEvent('wasabi_circlebar:log')
-- AddEventHandler('wasabi_circlebar:log', function(cause, killer)
