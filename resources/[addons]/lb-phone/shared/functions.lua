...
local locales = GenerateLocales(json.decode(LoadResourceFile(GetCurrentResourceName(), "config/locales/" .. (Config.DefaultLocale or "fr") .. ".json")))
local defaultLocales = GenerateLocales(json.decode(LoadResourceFile(GetCurrentResourceName(), "config/locales/fr.json")))
