...
function openInformation(alive) {
    ...
    if (alive) {
        base = base + '   <div id="button" onclick="feedPlant()">NOURRIR</div>' +
            '   <div id="button" onclick="waterPlant()">EAU</div>' +
            '   <div id="button" onclick="harvestPlant()">RECOLTER</div>';
    }


    base = base + '   <div id="button" onclick="destroyPlant()">ARRACHER</div>' +
        '   </div>' +
        '  </div>';
