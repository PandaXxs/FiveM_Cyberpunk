export default {
    ...
    DEFAULT_LOCALE: 'fr-FR', // en-US, fr-FR, de-DE, es-ES, it-IT, pt-PT, ru-RU, tr-TR, pl-PL, sr-RS, da-DK, af-ZA, ro-RO, lt-LT, el-GR, lb-LU, et-EE, fi-FI, sv-SE, zh-CN, bg-BG, hu-HU
