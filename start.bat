...
echo.
cd /d D:\Jeux\FiveM\projectrp-v3
D:\Jeux\FiveM\projectrp-v3\FXServer.exe +exec server.cfg
...
XCOPY D:\Jeux\FiveM\projectrp-v3\backup /m /e /y 
rem Changez les 2 chemins d'accès ci-dessus
echo.
...
RMDIR /s /q "D:\Jeux\FiveM\projectrp-v3\cache"
